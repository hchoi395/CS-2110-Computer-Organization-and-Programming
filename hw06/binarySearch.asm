...
BINARY_SEARCH ;; Do not change this label! Treat this as like the name of the function in a function header
    ...
    ;;now code BINARY_SEARCH(Node root (addr), int data)
    ...
    LDR R1, R5, 5   ;R1 = int data
    NOT R1, R1      ;data *= -1
    ADD R1, R1, #1
    ADD R1, R1, R3  ;R1 = -data + root.data
    BRnp END_IF2
    ...
    STR R0, R6, 0
    JSR BINARY_SEARCH
    LDR R2, R6, 0   ;R2 = BINARY_SEARCH(root.left, data)
    ADD R6, R6, 3   ;pop 3
    STR R2, R5, 3   ;return BINARY_SEARCH(root.left, data)
    BR TEARDOWN
    END_IF3 NOP
    ...
    STR R0, R6, 0
    JSR BINARY_SEARCH
    LDR R2, R6, 0   ;R2 = BINARY_SEARCH(root.right, data)
    ADD R6, R6, 3   ;pop 3
    STR R2, R5, 3   ;return BINARY_SEARCH(root.right, data)
    BR TEARDOWN
